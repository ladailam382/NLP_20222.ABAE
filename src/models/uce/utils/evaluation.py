...
def predict_uce(input):
    ...
    parser.add_argument('--train_data', default="src/models/uce/Data/CitySearch/train_skipgram_embedding_dim_200.zip" , type=str, help='train data')
    parser.add_argument('--test_data', default="src/models/uce/Data/test_data.zip", type=str, help='test data')
    parser.add_argument('--val_data', default=None, type=str, help='validation data')
    parser.add_argument('--seed_data', default="src/models/uce/Data/seed_word/city_search_seed_word.txt", type=str, help='seed data')
    parser.add_argument('--w2v', default='src/models/uce/Data/CitySearch/skipgram_embedding_dim_200', type=str, help='path of word2v model')
